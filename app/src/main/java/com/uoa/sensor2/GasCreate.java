...
// * Use the {@link Gascreate#newInstance} factory method to
...
public class GasCreate extends Fragment implements View.OnClickListener {
    ...
    private GasSensorListener listener;
...
//     * @return A new instance of fragment Gascreate.
//     */
    // TODO: Rename and change types and number of parameters
//    public static Gascreate newInstance(String param1, String param2) {
//        Gascreate fragment = new Gascreate();
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gas_create, container, false);

        Button button = view.findViewById(R.id.Gasbutton);
    ...
    public void onAttach(@NotNull Context context) {
        ...
        if (context instanceof Activity) {
            ...
            try {
                this.listener = (GasSensorListener) activity;
            } catch (final ClassCastException e) {
                throw new ClassCastException(activity.toString() + " createGas");
            }
        }
    }
    ...
    private void rangeExtrema() {
        ...
        myViewModel.setGasMinimum(slider.getValues().get(0));
        myViewModel.setGasMaximum(slider.getValues().get(1));
    }
}