...
// * Use the {@link Smokecreate#newInstance} factory method to
...
//     * @return A new instance of fragment Smokecreate.
//     */
    // TODO: Rename and change types and number of parameters
//    public static Smokecreate newInstance(String param1, String param2) {
//        Smokecreate fragment = new Smokecreate();
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_smoke_create, container, false);

        Button button = view.findViewById(R.id.Smokebutton);
    ...
    public void onAttach(@NotNull Context context) {
        ...
        if (context instanceof Activity) {
            ...
            try {
                this.listener = (SmokeSensorListener) activity;
            } catch (final ClassCastException e) {
                throw new ClassCastException(activity.toString() + " createSmoke");
            }
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.Smokebutton) {
            rangeExtrema();
            listener.onCreateSmokeSensor();
        }
    }
    private void rangeExtrema() {
        RangeSlider slider = requireView().findViewById(R.id.SmokeRangeSlider);
        myViewModel.setSmokeMinimum(slider.getValues().get(0));
        myViewModel.setSmokeMaximum(slider.getValues().get(1));
    }
}